...
module.exports = {
    ...
    view: function ({ attrs }) {
        ...
        return (
            <Body title='Bingo Close Seconds'>
                <List title="Close Seconds" items={summaryData.leaderboard} mapFunction={player => player} />
                ...
                <div class="uk-flex uk-flex-right">
                    <button class="uk-button uk-button-primary uk-padding-small uk-text-large" onclick={(e) => {
                        rmb.sendToGameServer(rmb.Message.ShowUnluckyWinners);
                    }}>
                        Next
                    </button>
                </div>
